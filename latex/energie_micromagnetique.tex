...
\begin{equation}
    E_{\text{dém}} = -\frac{1}{2}\mu_0 M_s \vec{H}_d \cdot \vec{m} = \frac{1}{2}\mu_0 M_s^2 \; m_\rho(\rho)^2
\end{equation}
...
\section{Énergie Totale en unités réduites}
\[
\boxed{
E=2\pi \int_\epsilon^1
\left[
A \rho (\frac{d \omega}{d\rho})^2+
\left(\frac{A}{\rho}+K_u R^2 \rho\right)\sin^2\omega
\right]d\rho
}
\]
...
\[
\boxed{
E=2\pi \int_\epsilon^1  A
\left[
\rho \left(\frac{d \omega}{d\rho}\right)^2+
\left(\frac{1}{\rho}+2 \kappa  \rho\right)\sin^2\omega
\right]d\rho
}
\]
